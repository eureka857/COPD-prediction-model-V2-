...
def user_input_features():
    ...
    options6 = {'仅剧烈活动后气促/Shortness of breath only after strenuous activity': 0, '平地快走或爬坡时气促/Short of breath when walking or climbing fast on flat ground': 1, '走100m或爬2层楼即感气促/Walking 100m or climbing two floors is short of breath': 2, '日常生活或休息时也感气促/Shortness of breath during daily life or at rest': 6, '我因其他疾病而不能活动/I was immobilized by other illnesses': 3}
